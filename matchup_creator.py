...
if __name__ == "__main__":
    ...
    final_stats_2021_df = pd.read_pickle(f"{transformed_data}/season_2022_gamelog_final_stats_data.pkl")
    ...
    final_stats_experience_cluster_merge(final_stats_2021_df, team_experience_df, team_clusters_df, season=2022)
